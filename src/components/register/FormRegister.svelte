    ...
    <form on:submit|preventDefault={handleSubmitParent} id="form-register">
      ...
      <div class="item-input">
        ...
        <input
          type="text"
          id="lastnameParent"
          bind:value={lastNameParentInput}
          required
        />
      </div>
      ...
      <div class="item-input">
        ...
        <input
          type="text"
          id="cellphoneParent"
          bind:value={cellphoneParentInput}
        />
      </div>
    ...
    <form on:submit|preventDefault={handleSubmitPacient} id="form-register">
      ...
      <div class="item-input">
        ...
        <input
          type="text"
          id="lastnamePacient"
          bind:value={lastNamePacientInput}
          required
        />
      </div>
      ...
      <div class="item-input">
        ...
        <input
          type="date"
          id="birthdatePacient"
          bind:value={birthdatePacientInput}
          required
        />
      </div>
